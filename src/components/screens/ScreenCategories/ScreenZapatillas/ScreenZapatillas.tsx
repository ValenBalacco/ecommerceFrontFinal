...
const ScreenZapatillas = () => {
  const [productosZapatillas, setProductosZapatillas] = useState<Detalle[]>([]);
  ...
  useEffect(() => {
    ...
    detalleService
      ...
      .catch(() => setProductosZapatillas([]));
  }, []);

  const productosFiltrados = productosZapatillas.filter((producto) => {
...
export default ScreenZapatillas;